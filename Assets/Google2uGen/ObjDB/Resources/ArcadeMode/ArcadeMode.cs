...
{
	[System.Serializable]
	public class ArcadeModeRow : IGoogle2uRow
	{
	...
	public class ArcadeMode :  Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds {
			WAVE_1, WAVE_2, WAVE_3, WAVE_4, WAVE_5, WAVE_6, WAVE_7, WAVE_8, WAVE_9, WAVE_10, WAVE_11, WAVE_12, WAVE_13, WAVE_14, WAVE_15, WAVE_16, WAVE_17, WAVE_18
			, WAVE_19, WAVE_20
		};
		...
		public System.Collections.Generic.List<ArcadeModeRow> Rows = new System.Collections.Generic.List<ArcadeModeRow>();
		public override void AddRowGeneric (System.Collections.Generic.List<string> input)
		{
			Rows.Add(new ArcadeModeRow(input[0],input[1],input[2],input[3],input[4],input[5],input[6],input[7],input[8],input[9],input[10],input[11],input[12],input[13],input[14],input[15],input[16],input[17],input[18],input[19],input[20]));
		}
		...
		public ArcadeModeRow GetRow(rowIds in_RowID)
		{
			ArcadeModeRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public ArcadeModeRow GetRow(string in_RowString)
		{
			ArcadeModeRow ret = null;
			try
			{

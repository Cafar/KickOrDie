...
{
	[System.Serializable]
	public class HardModeRow : IGoogle2uRow
	{
	...
	public class HardMode :  Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds {
		...
		public System.Collections.Generic.List<HardModeRow> Rows = new System.Collections.Generic.List<HardModeRow>();
		public override void AddRowGeneric (System.Collections.Generic.List<string> input)
		{
			Rows.Add(new HardModeRow(input[0],input[1],input[2],input[3],input[4],input[5],input[6],input[7],input[8],input[9],input[10],input[11],input[12],input[13],input[14],input[15],input[16],input[17],input[18],input[19],input[20]));
		}
		...
		public HardModeRow GetRow(rowIds in_RowID)
		{
			HardModeRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public HardModeRow GetRow(string in_RowString)
		{
			HardModeRow ret = null;
			try
			{
